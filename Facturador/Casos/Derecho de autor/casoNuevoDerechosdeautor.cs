...
{
    public partial class casoNuevoDerechosdeautor : Form
    {
        public Form1 fLoguin;
        public captura captura;
        public String sTipodesolicitudg;
        public casoNuevoDerechosdeautor(int iGrupo, captura capturaform, Form1 loguin)
        {
            fLoguin = loguin;
            captura = capturaform;
        ...
        private void comboBoxContacto_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                sCorreocontacto += validareader("ContactoEmail", "ContactoId", resp_correoscontact).Text;
            }
