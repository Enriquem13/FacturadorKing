...
{
    public partial class NuevocasoTransferido : Form
    {
        public Form1 login;
        ...
        public NuevocasoTransferido(int iTiposolicitud, captura cap, Form1 loguinparam)
        {
            login = loguinparam;
            cFcaptura = cap;
            ...
            //Consultamos tipo de Ley
            conect conect_2 = new conect();
            String querys = "select * from Ley ";
            MySqlDataReader respuestastrings = conect_2.getdatareader(querys);
            while (respuestastrings.Read())
            {
                comboLey.Items.Add(validareader("Nombre", "ID_Ley", respuestastrings));
            }
            ...
            //
            conect conect_chacter = new conect();
            String query3s = "select * from tipopct;";
            MySqlDataReader respuestastringidioms = conect_chacter.getdatareader(query3s);
            while (respuestastringidioms.Read())
            {
                comboboxSubtipo2.Items.Add(validareader("TipoPctDescrip", "TipoPctId", respuestastringidioms));
            }
            respuestastringidioms.Close();
            conect_chacter.Cerrarconexion();
        ...
        private void button1_Click(object sender, EventArgs e)//para insertar un nuevo caso
        {
            ...
            try
            {
                ...
                String scomboLey = validacombobox(comboLey); 
                ...
                String sFechaRecepcion = FechaRecepcion.Text;//FechaRecepcioncasofechalegal  CasoFechaLegal
                String stextFechaInternaciona = textFechaInternaciona.Text;//CasoFechaInternacional fecha internacional
                String stextBoxReferencia = textBoxReferencia.Text;//pendiente
                String srichTextBoxTitulo = richTextBoxTitulo.Text;//Casotitulo
                String sFechaVigencia = FechaVigencia.Text;//FechaVigencia
                String sresponsableid = login.sId;
                String sTituloespanol = "";
                String sTituloIngles = "";
                String sFechaConsecion = FechaConsecion.Text;
                String sFechasistema = DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss");
                //Nuevos campos Fechas
                String stextBoxFechainternacional = textBoxFechainternacional.Text;
                String sFechaVigencias = FechaVigencia.Text;
                String stextBoxPlazolegal = textBoxPlazolegal.Text; 
                //otros campos
                String sNoRegistro = NoRegistro.Text;
                String sExpediente = Expediente.Text; 
                String sSolicitudInternacional = SolicitudInternacional.Text;
                
                if (sComboboxSubtipo =="1")
                {
                    if (stextFechaInternaciona =="") {
                        MessageBox.Show("Debe Llenar Fecha Internacional");
                        return;
                    }
 
                }
                if (sSolicitudInternacional == "")
                {
                    MessageBox.Show("Debe Llenar No. Solicitud Internacional");
                    return;
                ...
                {
                    if (sExpediente =="") {
                        MessageBox.Show("Debe de registrar el Expediente");
                        return;
                    }
                }
                if (sNoRegistro == "")
                {
                    MessageBox.Show("Numero de registro no puede ir vacio");
                    return;
                }
                ...
                if(scomboLey == "")
                {
                    MessageBox.Show("Tiene que elegir una Ley");
                    return;
                }
                String sEstatudID = sEstatusid;
                if (FechaRecepcion.Text != "")
                {


                    DateTime FechaSt = Convert.ToDateTime(date1, myCIintl);
                    DateTime Fechalegal = Convert.ToDateTime(FechaRecepcion.Text, myCIintl);
                    if (Fechalegal < FechaSt && comboLey.Text == "Nueva Ley")
                    {
                        MessageBox.Show("No puede tener Ley Nueva con Fecha Recepcion Anterior 05-11-2020");
                        return;

                    }
                    if (Fechalegal > FechaSt && comboLey.Text == "Vieja Ley")
                    {
                        MessageBox.Show("No puede tener Ley Vieja con Fecha Recepcion posterior 05-11-2020");
                        return;

                    }
                }
                /*if (sFechaRecepcion != "" && (comboTiposolicitud.SelectedItem as ComboboxItem).Value != "3" && (comboTiposolicitud.SelectedItem as ComboboxItem).Value != "4")
                {//decimos que es diferente de diseños, entonces le sumamos 8 meses
                    DateTime dFechaRecepcion = DateTime.Parse(sFechaRecepcion);
                    dFechaRecepcion = dFechaRecepcion.AddMonths(12);
                }
                else {
                    if ((comboTiposolicitud.SelectedItem as ComboboxItem).Value == "3" && (comboTiposolicitud.SelectedItem as ComboboxItem).Value == "4")
                    {
                        DateTime dFechaRecepcion = DateTime.Parse(sFechaRecepcion);
                        dFechaRecepcion = dFechaRecepcion.AddMonths(6);
                    }
                }*/
                ...
                if (tbClavepaiscaso.Text != "" && sTextboxFecha != "" && stextBoxReferencia != "" && srichTextBoxTitulo != "" && sComboTiposolicitud != "" && sComboBoxClientes != "" && sComboBoxInteresado != "")
                {
                    if (validafechacorecta(TexboxFecha.Text) != "" && validafechacorecta(textClientduedate.Text) != "")
                    {
                        if (sComboboxSubtipo != "3")//Regular ley local, no debemos validar la fecha internacional
                        {
                            ...
                            if (validafechacorectaformato(textFechaInternaciona.Text, "dd-MM-yyyy", "yyyy'/'MM'/'dd") == "" &&
                         ...
                         * y validamos si ya existe el número de prioridades
                         */
                        sFechaRecepcion = cambiaformatofecha(sFechaRecepcion);
                        sFechaConsecion = cambiaformatofecha(sFechaConsecion);
                        sFechaVigencia = cambiaformatofecha(sFechaVigencia);
                        sTextboxFecha = cambiaformatofecha(sTextboxFecha);
                        stextClientduedate = cambiaformatofecha(stextClientduedate);
                        stextFechaInternaciona = cambiaformatofecha(stextFechaInternaciona);
                        ...
                        if (textFechaInternaciona.Text == "")
                        {
                            sFechaintenacionalinsert = "null";
                        }
                        else
                        {
                            sFechaintenacionalinsert = "'" + validafechacorectaformato(textFechaInternaciona.Text, "dd-MM-yyyy", "yyyy'/'MM'/'dd") + "'";
                        }

                        if (sFechaRecepcion == "")
                        {
                            sFechaRecepcion = "null";
                        }
                        else
                        {
                            sFechaRecepcion = "'" + sFechaRecepcion + "'";
                        }
                        ...
                        String sQueryinsertpat = "INSERT INTO `caso_patente` (`CasoId`, " +
                                                                                    ...
                                                                                    " `CasoNumero`, " +
                                                                                    " `CasoNumConcedida`, " +    // Numero de registro                        
                                                                                    " `ResponsableId`, " +
                                                                                    " `CasoTitular`, " +
                                                                                    " `EstatusCasoId`, " +
                                                                                    " `UsuarioId`, " +
                                                                                    ...
                                                                                    " " + scomboLey + ", " +
                                                                                    " '" + sComboBoxIdioma + "', " +
                                                                                    " " + sFechaRecepcion + ", " +//CASOFECHALEGAL
                                                                                    " '" + sCasonumero + "', " +
                                                                                    " '" + sNoRegistro + "', " +
                                                                                    " '" + sresponsableid + "', " +
                                                                                    ...
                                                                                    " " + sFechaRecepcion + ", " +
                                                                                    " '" + sFechaConsecion + "', " +
                                                                                    " '" + sSolicitudInternacional + "', " +//Fecha Internacional
                        ...
                        if (bcasopatente && bCasocliente && bCasointeresado && bCasoreferencias)
                        {
                            ...
                            String ssFechaVigencia = hoymasundia.ToString("yyyy-MM-dd");
        ...
        public void comboley_selectedindexchanged(object sender, EventArgs e)
        {
            try
            {

                //comboLey.Items.Clear();
                //comboLey.Text = "";
                string tipo = (comboLey.SelectedItem as ComboboxItem).Value.ToString();

                    conect con = new conect();
                    String query = "select * from Ley";
                    string valor = (comboLey.SelectedItem as ComboboxItem).Value.ToString();
                    MySqlDataReader respuestastring = con.getdatareader(query);
                    while (respuestastring.Read())
                    {
                    //comboLey.Items.Add(validareader("Nombre", "Id_Ley", respuestastring));
        ...
        private void textBox6_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                ...
                if (NoRegistro.TextLength >= 3)
                {
                    if (NoRegistro.Text.Substring(0, 3).Equals("PCT"))
                    {

                        comboBoxTipodos.SelectedItem = "PCT";
                        comboBoxTipodos.Text = "PCT";

                        if (NoRegistro.TextLength >= 10)
                        {

                            for (int x = 0; x < paises.Length; x++)
                            {
                                if (paises[x] == NoRegistro.Text.Substring(4, 2))
                                {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            //}
            //else { 
            if (NoRegistro.Text != "" && textBoxFecha.Text != "" && comboBoxPais.Text != "" && comboBoxTipodos.Text != "")
            {
                if (NoRegistro.Text.Substring(0, 3).Equals("PCT"))
                {
                    ...
                    if (textBoxFecha.Text.Substring(6, 4).Equals(NoRegistro.Text.Substring(6, 4)))
                    {
                        ListViewItem lPrioridades = new ListViewItem(NoRegistro.Text);
                    ...
                    {
                        //MessageBox.Show(textBoxFecha.Text.Substring(6, 4) + " vs " + NoRegistro.Text.Substring(6, 4));
        ...
        private void textBoxPlazolegal_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (FechaRecepcion.Text.Length == 2)
            {
                FechaRecepcion.Text = FechaRecepcion.Text + "-";
                FechaRecepcion.SelectionStart = FechaRecepcion.Text.Length;

            }
            if (FechaRecepcion.Text.Length == 5)
            {
                FechaRecepcion.Text = FechaRecepcion.Text + "-";
                FechaRecepcion.SelectionStart = FechaRecepcion.Text.Length;
            }
        }
        private void FechaRecepcion_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar))
            {
                e.Handled = false;
        ...
        private void textFechaInternaciona_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (Char.IsDigit(e.KeyChar))
            {
                e.Handled = false;
            ...
            if (textFechaInternaciona.Text.Length == 2)
            {
                textFechaInternaciona.Text = textFechaInternaciona.Text + "-";
                textFechaInternaciona.SelectionStart = textFechaInternaciona.Text.Length;

            }
            if (textFechaInternaciona.Text.Length == 5)
            {
                textFechaInternaciona.Text = textFechaInternaciona.Text + "-";
                textFechaInternaciona.SelectionStart = textFechaInternaciona.Text.Length;
            }
        ...
        {
            addClientenuevo aClientenuevo = new addClientenuevo(this, login, sComboTiposolicitud);
            ...
            try
            {
                if (NoRegistro.Text != "" && textBoxFecha.Text != "" && comboBoxPais.Text != "" && comboBoxTipodos.Text != "")
                {
                    if (validafechacorecta(textBoxFecha.Text) != "")
                    {
                        ...
                        if (NoRegistro.Text.Substring(0, 3).Equals("PCT") && comboBoxTipodos.Text == "PCT")
                        {
                            if (!bPrioridadpctagregada)
                            {
                                MessageBox.Show("Ya existe una prioridad tipo PCT.");
                            ...
                            if (textBoxFecha.Text.Substring(6, 4).Equals(NoRegistro.Text.Substring(6, 4)))
                            {
                                if (validarprioridades())
                                {
                                    ...
                                    textFechaInternaciona.Text = textBoxFecha.Text;
                                    //vaciamos los campos
                                    NoRegistro.Text = "";
                                    textBoxFecha.Text = "";
                                    comboBoxPais.Text = "";
            ...
            try
            {
                ...
                */
                ...
                String sGetcasonumero_prio = " SELECT  " +
                                                ...
                                                "     and PrioridadNumero LIKE '%" + NoRegistro.Text + "%'; ";
        ...
        public void validarfechalegal()
        {//calida la fecha más antigua para ponerla en el campo de fecha legal
            String datemenor = "";
            bool bMesesaddPCT = false;
            if (listViewPrioridades.Items.Count == 1)
            {
                //FechaRecepcion.Text = listViewPrioridades.Items[0].SubItems[1].Text;
                ...
                FechaRecepcion.Text = fechasumadas.ToString().Substring(0, 10);
                return;
            }
            ...
            FechaRecepcion.Text = fechasumada.ToString().Substring(0, 10);
        }
        ...
        private void FechaRecepcion_Validating(object sender, CancelEventArgs e)
        {
            objfuncionesdicss.validafecha(FechaRecepcion);
        }
        ...
        private void textFechaInternaciona_Validating(object sender, CancelEventArgs e)
        {
            objfuncionesdicss.validafecha(textFechaInternaciona);
        }

        private void FechaRecepcion_TextChanged(object sender, EventArgs e)
        {
            ...
            //    DateTime.TryParse(FechaRecepcion.Text, out dDatePlazolegal);
        ...
        private void NoRegistro_TextChanged(object sender, EventArgs e)
        {
            try
            {
                String sPrioridad = NoRegistro.Text.Trim();
                NoRegistro.Text = sPrioridad;
